...
import com.weichao.keshi.view.SelectDialog;
...
public class LoseAddActivity extends BaseActivity implements ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    @Bind(R.id.sp_lose_kind)
    Spinner spLoseKind;
    @Bind(R.id.et_lose_tel)
    EditText etLoseTel;
    @Bind(R.id.bt_lose_add)
    Button btLoseAdd;
    @Bind(R.id.et_lose_desc)
    EditText etLoseDesc;
    @Bind(R.id.spnYear)
    Spinner spnYear;
    @Bind(R.id.tvYear)
